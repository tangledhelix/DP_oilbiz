...
./make_project.py
```
* [ ] Read the [project comments](https://www.pgdp.net/c/project.php?id=projectID6439914e322af#project-comments)
* [ ] Subscribe to the [forum topic](https://www.pgdp.net/phpBB3/viewtopic.php?t=79215) and read all posts
* [ ] Open `oilbiz-utf8.txt` in Guiguts
...
* [ ] Re-open `oilbiz-utf8.txt` (if not still open).
