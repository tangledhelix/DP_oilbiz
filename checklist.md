...
* [x] Open `oilbiz.html` that was saved previously.
...
* [x] Go to [project page](https://www.pgdp.net/c/project.php?id=projectID6439914e322af), select SR time period, upload `oilbiz-sr.zip`
...
* [x] Add **anonymized** files to git, e.g. `oilbiz-smoothread01.txt`
...
* [x] Enter copyright clearance (get from DP [project page](https://www.pgdp.net/c/project.php?id=projectID6439914e322af))
